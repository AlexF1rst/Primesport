...
<header>
    ...
    <div class="row">
        ...
        <article class="four columns featured_post">
            ...
            <a href="news-old.php?id=<?=$myrow['id']?>"> <h3><?=$myrow["title"]?> </h3></a>
            <a href="news-old.php?id=<?=$myrow['id']?>" class="th"><img src="assets/img/news/<?=$myrow["image"]?>" alt="desc" style="width:100%" /></a>
            <p> <?=$myrow["text"]?> </p>
            ...
            <section class="eight columns">
                ...
                <article class="blog_post">
                    ...
                    <div class="three columns">
                        <a href="news-old.php?id=<?=$myrow['id']?>" class="th"><img src="assets/img/news/<?=$myrow["image"]?>" alt="desc" /></a>
                    </div>
